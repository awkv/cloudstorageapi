 ...
 *
 * For some credential types (e.g. google service account impersonation) there may be
 ...
 */
class ErrorCredentials : public auth::Credentials
{
public:
    explicit ErrorCredentials(Status status) : m_status(std::move(status)) {}
