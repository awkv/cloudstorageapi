...
public:
    ...
    std::shared_ptr<auth::Credentials> GetCredentials() const { return m_credentials; }
    ...
    std::size_t GetMaximumSimpleUploadSize() const { return m_maximumSimpleUploadSize; }
     ...
     */
    bool GetEnableSslLockingCallbacks() const { return m_enableSslLockingCallbacks; }
    ...
    std::size_t GetMaximumSocketRecvSize() const { return m_maximumSocketRecvSize; }
    ...
    std::size_t GetMaximumSocketSendSize() const { return m_maximumSocketSendSize; }
     ...
     */
    std::chrono::seconds GetDownloadStallTimeout() const { return m_downloadStallTimeout; }
