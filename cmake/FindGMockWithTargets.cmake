...
function (csa_create_googletest_aliases)
...
function (csa_gmock_library_import_location target lib)
...
function (csa_transfer_library_properties target source)
...
elseif (NOT BUILD_TESTING)
    ...
    if (NOT GTest_FOUND)
        ...
        csa_gmock_library_import_location(GTest::gmock gmock)
        ...
        csa_gmock_library_import_location(GTest::gmock_main
                                                       gmock_main)
        set_target_properties(
            GTest::gmock_main
            PROPERTIES IMPORTED_LINK_INTERFACE_LIBRARIES
    ...
    if (NOT TARGET GTest::gmock AND TARGET GMock::gmock)
        csa_transfer_library_properties(GTest::gmock GMock::gmock)
        csa_transfer_library_properties(GTest::gmock_main
                                                     GMock::gmock_main)
    endif ()
endif ()